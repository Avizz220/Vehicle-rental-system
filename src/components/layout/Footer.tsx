        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Your trusted partner for premium vehicle rentals. Serving customers nationwide with quality and reliability.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/booking-support" className="text-gray-400 hover:text-white transition-colors">
                  Booking Support
                </Link>
              </li>
              <li>
